                                        ...
                                        @foreach($request_firm_phrma as $request)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{url('/accept-request/'.$request->id)}}" class="btn bg-success"><i class="icon-checkmark3"></i> موافق</a>
                                                    <a href="{{url('/reject-request/'.$request->id)}}" class="btn bg-danger"><i class="icon-cross3"></i>  غير موافق </a>
